...
declare namespace minimist {
  export interface Opts {
    ...
    /**
     * When true, allow `--option=value` format
     */
    equalsOptions?: boolean;

    /**
     * When true, allow option aliases to be used with `--` instead of just `-`
     */
    doubleDashAliases?: boolean;

    /**
     * When true, allow `--no-option` variants for all `--option` boolean options to negate
     */
    negateOptions?: boolean;
  }
